<template>
  <div class="bg-[url('@/assets/hero.png')] h-screen w-screen bg-cover bg-center bg-no-repeat">
    ...
    <div class="flex flex-col items-center justify-center my-11 py-12">
      ...
      <div class="py-12">
        <h3 class="text-white text-center text-lg m font-normal text-pretty">
      ...
      <div class="flex flex-row">
        <button
          class="border-2 rounded-sm text-white px-12 py-2 bg-[#285A43] hover:bg-white/20 hover:text-[#285A43] hover:font-semibold border-[#285A43]"
        >
          Book Now
        </button>
        <button
